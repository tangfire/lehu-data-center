...
type Data struct {
	...
	DataSources   []*Data_DataSource     `protobuf:"bytes,3,rep,name=data_sources,json=dataSources,proto3" json:"data_sources,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetDataSources() []*Data_DataSource {
	if x != nil {
...
type Data_DataSource struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Name          string                      `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Connection    *Data_DataSource_Connection `protobuf:"bytes,2,opt,name=connection,proto3" json:"connection,omitempty"`
...
func (x *Data_DataSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_DataSource) ProtoMessage() {}

func (x *Data_DataSource) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_DataSource.ProtoReflect.Descriptor instead.
func (*Data_DataSource) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_DataSource) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Data_DataSource) GetConnection() *Data_DataSource_Connection {
	if x != nil {
		return x.Connection
	}
	return nil
...
func (x *Data_DataSource) GetIsActive() bool {
	if x != nil {
		return x.IsActive
	}
	return false
...
func (x *Data_DataSource) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *Data_DataSource) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
type Data_DataSource_Connection struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Driver        string                 `protobuf:"bytes,1,opt,name=driver,proto3" json:"driver,omitempty"`
...
func (x *Data_DataSource_Connection) Reset() {
	*x = Data_DataSource_Connection{}
	mi := &file_conf_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Data_DataSource_Connection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_DataSource_Connection) ProtoMessage() {}

func (x *Data_DataSource_Connection) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_DataSource_Connection.ProtoReflect.Descriptor instead.
func (*Data_DataSource_Connection) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{2, 2, 0}
}

func (x *Data_DataSource_Connection) GetDriver() string {
	if x != nil {
		return x.Driver
	}
	return ""
...
func (x *Data_DataSource_Connection) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *Data_DataSource_Connection) GetPort() int32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *Data_DataSource_Connection) GetDatabase() string {
	if x != nil {
		return x.Database
	}
	return ""
...
func (x *Data_DataSource_Connection) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *Data_DataSource_Connection) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Data_DataSource_Connection) GetParameters() map[string]string {
	if x != nil {
		return x.Parameters
	}
	return nil
...
const file_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x9b\t\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12>\n" +
	"\fdata_sources\x18\x03 \x03(\v2\x1b.kratos.api.Data.DataSourceR\vdataSources\x1a\xcd\x01\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12$\n" +
	"\x0emax_idle_conns\x18\x03 \x01(\x05R\fmaxIdleConns\x12$\n" +
	"\x0emax_open_conns\x18\x04 \x01(\x05R\fmaxOpenConns\x12E\n" +
	"\x11conn_max_lifetime\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x0fconnMaxLifetime\x1a\x9d\x02\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	...
	"\fdial_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\vdialTimeout\x1a\xfd\x03\n" +
	"\n" +
	"DataSource\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12F\n" +
	"\n" +
	"connection\x18\x02 \x01(\v2&.kratos.api.Data.DataSource.ConnectionR\n" +
	"connection\x12\x1b\n" +
	"\tis_active\x18\x03 \x01(\bR\bisActive\x12\x1d\n" +
	"\n" +
	"created_at\x18\x04 \x01(\x03R\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\x03R\tupdatedAt\x1a\xb7\x02\n" +
	"\n" +
	"Connection\x12\x16\n" +
	...
	"\bpassword\x18\x06 \x01(\tR\bpassword\x12V\n" +
	"\n" +
	"parameters\x18\a \x03(\v26.kratos.api.Data.DataSource.Connection.ParametersEntryR\n" +
	"parameters\x1a=\n" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06schemeB>Z<lehu-data-center/app/agility_data/service/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	...
	(*Data_DataSource)(nil),            // 8: kratos.api.Data.DataSource
	(*Data_DataSource_Connection)(nil), // 9: kratos.api.Data.DataSource.Connection
	nil,                                // 10: kratos.api.Data.DataSource.Connection.ParametersEntry
...
var file_conf_proto_depIdxs = []int32{
	...
	8,  // 6: kratos.api.Data.data_sources:type_name -> kratos.api.Data.DataSource
	11, // 7: kratos.api.Registry.consul:type_name -> kratos.api.Registry.Consul
	...
	12, // 10: kratos.api.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
	...
	9,  // 14: kratos.api.Data.DataSource.connection:type_name -> kratos.api.Data.DataSource.Connection
	10, // 15: kratos.api.Data.DataSource.Connection.parameters:type_name -> kratos.api.Data.DataSource.Connection.ParametersEntry
