...
type Bootstrap struct {
	...
	Snoyflake     *Snoyflake             `protobuf:"bytes,3,opt,name=snoyflake,proto3" json:"snoyflake,omitempty"`
...
func (x *Bootstrap) GetSnoyflake() *Snoyflake {
	if x != nil {
		return x.Snoyflake
	}
	return nil
...
func (x *Snoyflake) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Snoyflake) ProtoMessage() {}

func (x *Snoyflake) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Snoyflake.ProtoReflect.Descriptor instead.
func (*Snoyflake) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{3}
}

func (x *Snoyflake) GetWorkerId() int64 {
	if x != nil {
		return x.WorkerId
	}
	return 0
...
const file_conf_proto_rawDesc = "" +
	...
	"\tsnoyflake\x18\x03 \x01(\v2\x15.kratos.api.SnoyflakeR\tsnoyflake\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06schemeB>Z<lehu-data-center/app/id_generator/service/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	...
	(*Snoyflake)(nil),           // 3: kratos.api.Snoyflake
...
var file_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.snoyflake:type_name -> kratos.api.Snoyflake
